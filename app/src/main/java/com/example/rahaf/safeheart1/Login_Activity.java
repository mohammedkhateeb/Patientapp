...
/*
    ...
    {
        final String username = txtID.getText().toString();
        ...
        BackgroundWorker backgroundWorker = new BackgroundWorker(new AsyncResponse() {
            ...
            public void onFinish(Object output) {
                String patient_name = (String) output;
                Intent myIntent = new Intent(Login_Activity.this, User_Activity.class);
                myIntent.putExtra("ID",username);
                myIntent.putExtra("key", patient_name);
                startActivity(myIntent);
            }
        });
        backgroundWorker.execute(type, username, password); //pass multiple arguments here
